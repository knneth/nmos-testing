...
export IPMX_REGISTRY_ADDRESS=10.20.10.45
export IPMX_REGISTRY_PORT=8870
export IPMX_SENDER_ADDRESS=10.20.10.160
...
export IPMX_RECEIVER_ADDRESS=10.20.10.152
...
export IPMX_VENDOR=Matrox
# export IPMX_VENDOR_PCAP_CAPTURE=VB440
